...
export default function Suggest() {
  ...
  return (
    <div className="container flex flex-col font-nanumGothic bg-[--black-500] gap-[--gap-md]">
      <Paper square elevation={0} className="flex flex-col  gap-[--gap-sm] py-[--gap-md] px-[--gap-sm]">
      ...
      <Paper square elevation={0} className="py-[--gap-md] flex flex-col  gap-[--gap-sm] px-[--gap-sm]">
        <h1 className="font-semibold"><span className="text-[--blue-100]">건강고민</span>별 영양제 찾기</h1>
        <ConcerTab />
      </Paper>
      <Paper square elevation={0} className="flex flex-col  gap-[--gap-sm] py-[--gap-md] px-[--gap-sm]">
        <h1 className="text-[--blue-100] font-semibold">생활 건강 정보</h1>
        <Grid 
        container 
        spacing={2} 
        className="
        [&>div>div]:relative [&>div>div]:h-full [&>div>div]:w-full
        [&>div>div>img]:object-cover [&>div>div>img]:object-center
        [&>div>div>p]:font-semibold [&>div>div>p]:p-[--gap-sm] [&>div>div>p]:relative
        [&>div:nth-child(4n)>div>p]:pt-32 [&>div:nth-child(4n)>div>p]:text-right
        [&>div:nth-child(4n+1)>div>p]:pb-32
        [&>div:nth-child(4n+2)>div]:flex [&>div:nth-child(4n+2)>div>p]:self-center [&>div:nth-child(4n+2)>div>p]:text-center
        [&>div:nth-child(4n+3)>div]:flex [&>div:nth-child(4n+3)>div>p]:self-center [&>div:nth-child(4n+3)>div>p]:text-center
        "
        >
          <Grid xs={6}>
